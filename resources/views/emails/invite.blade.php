                ...
                <table class="main" width="100%" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="font-size: 18px; color: #fff; font-weight: 500; padding: 20px; text-align: center; border-radius: 3px 3px 0 0; background: #265876;">
                            You have received a Invitation!
                        </td>
                    </tr>
                    <tr>
                                ...
                                <tr>
                                    <td style="padding: 0 0 20px;">
                                        <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">
                                            Your Friend <b>{{ $user->name}}</b> made you a invitation to our Social Network system of events, come and enjoy! =D
                                        </p>
                                        <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">
                                            <a href="{{url('api/auth/register')}}">Sign Up!</a>
                                        </p>
                                    </td>
                                </tr>
                                </tbody>
